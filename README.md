...
- `ghcr.io/ripples-alive/mihomo:1.19.27`
- `ghcr.io/ripples-alive/mihomo:1.19.27-compatible`
...
Local builds use `build.sh`, which pushes `ripples/mihomo:1.19.27` and
`ripples/mihomo:1.19.27-compatible` to Docker Hub for `linux/amd64`.
...
Images are published on pushes to `main`, version tags such as `v1.19.27`, and
